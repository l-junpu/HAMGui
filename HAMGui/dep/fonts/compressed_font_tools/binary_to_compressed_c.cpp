...
int main()
{
    ...
    bool ret = binary_to_compressed_c( R"(C:\Users\User\source\repos\HAMGui\HAMGui\dep\fonts\static\Ruda-Bold.ttf)", "RudaBold", use_base85_encoding, use_compression, use_static);
    if (!ret)
        std::cout << "Welps" << std::endl;
    return ret ? 0 : 1;
}
